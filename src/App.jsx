  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="teacher/lms" element={
          <ProtectedRoute requiredRole="teacher"><TeacherCourseList /></ProtectedRoute>
        } />
        <Route path="teacher/lms/:courseId" element={
          <ProtectedRoute requiredRole="teacher"><CourseDetail /></ProtectedRoute>
        } />
        <Route path="teacher/lms/:courseId/lesson/:lessonId" element={
          <ProtectedRoute requiredRole="teacher"><LessonPlayer /></ProtectedRoute>
        } />
        <Route path="teacher/lms/:courseId/quiz" element={
          <ProtectedRoute requiredRole="teacher"><QuizPage /></ProtectedRoute>
        } />
        <Route path="teacher/reports" element={
          <ProtectedRoute requiredRole="teacher"><TeacherReports /></ProtectedRoute>
        } />
        <Route path="teacher/reports/new" element={
          <ProtectedRoute requiredRole="teacher"><SubmitReport /></ProtectedRoute>
        } />
        <Route path="teacher/reports/:reportId" element={
          <ProtectedRoute requiredRole="teacher"><ReportDetail /></ProtectedRoute>
        } />
        ...
        <Route path="admin/monitoring" element={
          <ProtectedRoute requiredRole="admin"><AdminMonitoring /></ProtectedRoute>
        } />
        <Route path="admin/reports" element={
          <ProtectedRoute requiredRole="admin"><AdminReports /></ProtectedRoute>
        } />
        <Route path="admin/reports/:reportId" element={
          <ProtectedRoute requiredRole="admin"><ReportReview /></ProtectedRoute>
        } />
        <Route path="admin/schools" element={
          <ProtectedRoute requiredRole="admin"><SchoolManagement /></ProtectedRoute>
        } />
        <Route path="admin/schools/:schoolId" element={
          <ProtectedRoute requiredRole="admin"><SchoolDetail /></ProtectedRoute>
        } />
        <Route path="admin/users" element={
          <ProtectedRoute requiredRole="admin"><UserManagement /></ProtectedRoute>
        } />
        <Route path="admin/leaderboard" element={
          <ProtectedRoute requiredRole="admin"><AdminLeaderboard /></ProtectedRoute>
        } />

        {/* Gov Observer routes */}
        <Route path="gov/dashboard" element={
          <ProtectedRoute requiredRole="gov_observer"><GovDashboard /></ProtectedRoute>
        } />
        <Route path="gov/monitoring" element={
          <ProtectedRoute requiredRole="gov_observer"><GovMonitoring /></ProtectedRoute>
        } />
        <Route path="gov/reports" element={
          <ProtectedRoute requiredRole="gov_observer"><GovReports /></ProtectedRoute>
        } />
        <Route path="gov/leaderboard" element={
          <ProtectedRoute requiredRole="gov_observer"><GovLeaderboard /></ProtectedRoute>
        } />
